...
a1f321f06490        mongo:8.0.21                         "docker-entrypoint.s…"   23 minutes ago      Up 23 minutes           0.0.0.0:27017->27017/tcp   mongo
```
...
- Pulling the mongo 8.0.21 image image again from [DockerHub](https://hub.docker.com/).
...
:white_check_mark: You should check your __mongo__ version is same as used in image. You can see the version of __mongo__ image in `docker-compose `file, I used __image: mongo:8.0.21__. If your mongo db version on your machine is not same then furst you have to updated your  local __mongo__ version in order to works correctly.
