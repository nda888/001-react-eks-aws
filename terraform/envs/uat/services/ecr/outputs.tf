...
output "rotator_repository_url" {
  description = "ECR repository URL for mongo rotator image"
  value       = module.rotator_ecr.repository_url
}

output "rotator_repository_arn" {
  description = "ECR repository ARN for mongo rotator"
  value       = module.rotator_ecr.repository_arn
}
