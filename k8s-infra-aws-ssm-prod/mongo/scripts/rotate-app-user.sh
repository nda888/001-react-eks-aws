...
# --- Step 8: Save last-known app password for deploy-time drift reconciliation ---
echo "[rotate] Saving last-known app password"
kubectl -n "${NAMESPACE}" create secret generic mongo-app-password-last-known \
